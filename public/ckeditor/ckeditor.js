...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = {
            ...
            domReady: function () {
                function b() {
                    try {
                        document.addEventListener ? (document.removeEventListener("DOMContentLoaded", b, !1), a()) : document.attachEvent && "complete" === document.readyState && (document.detachEvent("onreadystatechange", b), a())
                    } catch (d) {}
                }
                        ...
                        if (p.length)
                            for (var p = p.slice(0), g, h = 0; h < p.length; h++) {
                                if (n.errorProof) try {
                                    g = p[h].call(this,
                                        m, i, a, j)
                                } catch (u) {} else g = p[h].call(this, m, i, a, j);
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        ...
        if (b.gecko)
            if (f <
                10900) b.cssClass = b.cssClass + " cke_browser_gecko18";
            else if (f <= 11E3) b.cssClass = b.cssClass + " cke_browser_gecko19";
        ...
        CKEDITOR.tools = {
            ...
            buildStyleHtml: function (b) {
                for (var b = [].concat(b), a, e = [], d = 0; d < b.length; d++)
                    if (a = b[d]) /@import|[{}]/.test(a) ? e.push("<style>" + a + "</style>") : e.push('<link type="text/css" rel=stylesheet href="' + a + '">');
                return e.join("")
            },
            ...
            normalizeCssText: function (b,
                a) {
                var e = [],
                    d, c = CKEDITOR.tools.parseCssText(b, true, a);
            ...
            convertRgbToHex: function (b) {
                return b.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function (b, a, d, c) {
                    b = [a, d, c];
                    for (a = 0; a < 3; a++) b[a] = ("0" + parseInt(b[a], 10)
                        .toString(16))
                        .slice(-2);
                    return "#" + b.join("")
                })
            ...
            parseCssText: function (b, a, e) {
                ...
                if (!b || b == ";") return d;
                b.replace(/&quot;/g, '"')
                    .replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (b, e, c) {
                        if (a) {
                            e = e.toLowerCase();
                            e == "font-family" && (c = c.toLowerCase()
                                .replace(/["']/g, "")
                                .replace(/\s*,\s*/g, ","));
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
            ...
            var b = this.$.cloneNode(a),
                f = function (b) {
                    ...
                    if (b.nodeType == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (a)
                            for (var b = b.childNodes, d = 0; d < b.length; d++) f(b[d])
                    }
                };
            f(b);
        ...
        getAddress: function (a) {
            for (var c = [], b = this.getDocument()
                    .$.documentElement, f = this.$; f && f != b;) {
                var e = f.parentNode;
        ...
        getCommonAncestor: function (a) {
            ...
            do
                if (c.contains(a)) return c; while (c = c.getParent());
            return null
        },
        ...
        remove: function (a) {
            ...
            if (b) {
                if (a)
                    for (; a = c.firstChild;) b.insertBefore(c.removeChild(a), c);
                b.removeChild(c)
            }
            return this
        },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        getHead: function () {
            ...
            return a =
                a ? new CKEDITOR.dom.element(a) : this.getDocumentElement()
    ...
    CKEDITOR.dom.element = function (a, c) {
        typeof a == "string" && (a = (c ? c.$ : document)
            .createElement(a));
        CKEDITOR.dom.domObject.call(this, a)
    };
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            append: function (b, a) {
                typeof b == "string" && (b = this.getDocument()
                    .createElement(b));
            ...
            appendBogus: function () {
                ...
                if (!b || !b.is || !b.is("br")) {
                    b = CKEDITOR.env.opera ? this.getDocument()
            ...
            contains: CKEDITOR.env.ie || CKEDITOR.env.webkit ? function (b) {
                var a = this.$;
                return b.type != CKEDITOR.NODE_ELEMENT ? a.contains(b.getParent()
                    .$) : a != b.$ && a.contains(b.$)
            } : function (b) {
            ...
            isVisible: function () {
                ...
                if (b && (CKEDITOR.env.webkit || CKEDITOR.env.opera)) {
                    a =
                        this.getWindow();
                    if (!a.equals(CKEDITOR.document.getWindow()) && (c = a.$.frameElement)) b = (new CKEDITOR.dom.element(c))
                        .isVisible()
                }
                return !!b
            },
            ...
            moveChildren: function (b, a) {
                ...
                if (c != b) {
                    var d;
                    if (a)
                        for (; d = c.lastChild;) b.insertBefore(c.removeChild(d), b.firstChild);
                    else
                        for (; d = c.firstChild;) b.appendChild(c.removeChild(d))
                }
            },
            mergeSiblings: function () {
                function b(b, a, c) {
                    if (a && a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (b.isIdentical(a)) {
                            for (var l = c ? b.getLast() : b.getFirst(); j.length;) j.shift()
                                .move(b, !c);
                            a.moveChildren(b, !c);
                            a.remove();
            ...
            removeAttributes: function (b) {
                if (CKEDITOR.tools.isArray(b))
                    for (var a = 0; a <
                        b.length; a++) this.removeAttribute(b[a]);
                else
                    for (a in b) b.hasOwnProperty(a) && this.removeAttribute(a)
            },
            removeStyle: function (b) {
                ...
                if (!a.removeProperty && (b == "border" || b == "margin" || b == "padding")) {
                    ...
                    for (var a = [], j = 0; j < c.length; j++)
                        if (d)
                            for (var l = 0; l < d.length; l++) a.push([b, c[j], d[l]].join("-"));
                        else a.push([b, c[j]].join("-"));
            ...
            getDocumentPosition: function (b) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    ...
                    if (!j.equals(d) && j.$.frameElement) {
                        b = (new CKEDITOR.dom.element(j.$.frameElement))
                            .getDocumentPosition(b);
                        a = a + b.x;
                        c = c + b.y
                    }
                }
            ...
            scrollIntoParent: function (b, a, c) {
                ...
                function m(a, c) {
                    if (/body|html/.test(b.getName())) b.getWindow()
                        .$.scrollBy(a, c);
                    else {
            ...
            copyAttributes: function (b, a) {
                for (var c = this.$.attributes, a = a || {}, d = 0; d < c.length; d++) {
                    var j = c[d],
                        ...
                        i;
                    if (!(l in a))
                        if (l == "checked" && (i = this.getAttribute(l))) b.setAttribute(l, i);
            ...
            getChild: function () {
                ...
                return function (a) {
                    var c = this.$;
                    if (a.slice)
                        for (; a.length > 0 && c;) c = b(c, a.shift());
                    else c = b(c, a);
            ...
            disableContextMenu: function () {
                this.on("contextmenu",
                    function (b) {
                        b.data.getTarget()
                            .hasClass("cke_enable_context_menu") || b.data.preventDefault()
                    })
            },
            getDirection: function (b) {
                return b ? this.getComputedStyle("direction") || this.getDirection() || this.getParent() && this.getParent()
    ...
    (function () {
        function a(a, b) {
            ...
            if (this.current) d = this.current[f](false, u, g);
            else {
                if (a) d.type ==
    ...
    (function () {
        function a() {
            ...
            return function (h) {
                ...
                return h.type == CKEDITOR.NODE_TEXT && (h.hasAscendant("pre") || CKEDITOR.tools.trim(h.getText())
                    .length) || h.type == CKEDITOR.NODE_ELEMENT && !h.is(d) ? false : true
            }
        }
                ...
                for (c = l; c < k.length; c++) {
                    ...
                    if (!f[c] || s.$.parentNode != f[c].$.parentNode)
                        for (s = s.getPrevious(); s;) {
                            ...
                            v = s.getPrevious();
                            if (b == 2) m.$.insertBefore(s.$.cloneNode(true), m.$.firstChild);
                            else {
                                s.remove();
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function (a) {
                ...
                if (a) {
                    if (b.type == CKEDITOR.NODE_ELEMENT) {
                        if ((f = b.getChild(g)) && f.type == CKEDITOR.NODE_TEXT && g > 0 && f.getPrevious()
                            .type ==
                            CKEDITOR.NODE_TEXT) {
                            b = f;
                            g = 0
                    ...
                    if (!d) {
                        if (c.type == CKEDITOR.NODE_ELEMENT) {
                            if ((f = c.getChild(h)) && f.type == CKEDITOR.NODE_TEXT && h > 0 && f.getPrevious()
            ...
            enlarge: function (a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    if (i.type == CKEDITOR.NODE_TEXT) {
                        if (q) {
                            i = !CKEDITOR.tools.trim(i.substring(0, q))
                                .length && i;
                            l = !! i
                        }
                    ...
                    j = l = false;
                    if (i.type == CKEDITOR.NODE_TEXT) {
                        i = !CKEDITOR.tools.trim(i.substring(q))
                            .length && i;
                        l = !(i && i.getLength());
            ...
            shrink: function (a, b, c) {
                if (!this.collapsed) {
                    ...
                    if (h && h.type == CKEDITOR.NODE_TEXT)
                        if (e)
                            if (e >= h.getLength()) g.setStartAfter(h);
                            else {
                                g.setStartBefore(h);
                                j = 0
                    ...
                    if (d && d.type == CKEDITOR.NODE_TEXT)
                        if (f)
                            if (f >= d.getLength()) g.setEndAfter(d);
                            else {
                                g.setEndAfter(d);
                                i = 0
            ...
            getNextParagraph: function (a) {
                    ...
                    if (!i.collapsed) {
                        ...
                        if (this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent()
                            ...
                            if (g.checkEndOfBlock()) {
                                ...
                                this._.lastNode = (g.block || g.blockLimit)
                ...
                for (this._.nextNode = null; g;) {
                    var h = 0,
                        ...
                        k = 0;
                    if (w) g.type == CKEDITOR.NODE_TEXT && b.test(g.getText()) && (w = 0);
                    else {
                        var t = g.getName();
                ...
                if (!e) {
                    ...
                    e = e.block;
                    if (!e && g && !this.enforceRealBlocks && h[g.getName()] && i.checkStartOfBlock() && i.checkEndOfBlock() && !g.equals(i.root)) e = g;
                    ...
                    } else if (!m) this._.nextNode = e.equals(n) ? null : c(i.getBoundaryNodes()
                        .endNode, 1, n)
                }
                if (r)(i = e.getPrevious()) && i.type == CKEDITOR.NODE_ELEMENT && (i.getName() == "br" ? i.remove() : i.getLast() && i.getLast()
                    .$.nodeName.toLowerCase() == "br" && i.getLast()
                    .remove());
    ...
    (function () {
            ...
            return b._.filterFunction = function (g, h, e, f, k, j, p) {
                ...
                if (h) {
                    ...
                    if (h.allStyles) {
                        ...
                        if (D.length) r.style = D.sort()
                            .join("; ")
                    } if (h.allClasses) q && (r["class"] = q);
                    else {
                        for (t in e) e[t] && s.push(t);
                        s.length && (r["class"] = s.sort()
                            .join(" "));
                        q && s.length < q.split(/\s+/)
                            .length && (z = true)
                    }
                    z && (l = true);
                    if (!p && !n(g)) {
        ...
        function d(a) {
            if (!a) return {};
            for (var a = a.split(/\s*,\s*/)
                .sort(), b = {}; a.length;) b[a.shift()] = z;
            return b
        }
        ...
        function m(a) {
            ...
            a.classes.length && (b["class"] = a.classes.sort()
                .join(" "))
        }
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function (a, b, c) {
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if (!b || !(a.name == "span" && ~CKEDITOR.tools.objectKeys(a.attributes)
                            .join("|")
                            .indexOf("data-cke-"))) k(a, g, e, d, b) && (u = true)
                        ...
                        a: {
                            ...
                            h.children.length == 1 && (f = h.children[0])
                                .type == CKEDITOR.NODE_ELEMENT && k(f, g, e, c, b);
                            c = !c.length
                        }
                        c || d.push(a)
                    }
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        for (e = 0; e < b.length; ++e) {
                            ...
                            if (typeof f == "string") {
                                ...
                                g = f;
                                g = g.element ? g.element : k ? k.match(/^([a-z0-9]+)/i)[0] : g.left.getDefinition()
                                    .element
                            }
                            o instanceof
            ...
            check: function (a, b, c) {
                ...
                if (CKEDITOR.tools.isArray(a)) {
                    for (var h = a.length; h--;)
                        if (this.check(a[h], b, c)) return true;
                    return false
                }
                var g, e;
                if (typeof a == "string") {
                        ...
                        if (--l <= 0) {
                            ...
                            if (a[b]) r(b, true);
                                ...
                                if (!(d.length >
                                    ...
                                    if (f)
                                        if (CKEDITOR.env.ie) h.$.onreadystatechange = function () {
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        addExternal: function (a, c, b) {
            for (var a = a.split(","), f = 0; f < a.length; f++) this.externals[a[f]] = {
                dir: c,
                file: b
            }
        },
            ...
            var d = {}, j = function (b) {
                    a.call(this, b, function (a) {
                        ...
                        for (l in a) {
                            ...
                            if (!c[l]) {
                                if (r.icons)
                                    for (var g = r.icons.split(","), h = 0; h < g.length; h++) CKEDITOR.skin.addIcon(g[h], r.path + "icons/" + g[h] + ".png");
                                c[l] = 1
                            }
                            if (p) {
                                p.split && (p = p.split(","));
    ...
    (function () {
        ...
        function n(a) {
            ...
            c = c.replace(e, ""), c = c + ("," + d);
            if (g) var f = RegExp("(?:^|,)(?:" + g.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
            c = c.replace(f, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var k in c) {
                    ...
                    if (i && (r = i.match(f)))
                        for (; i = r.pop();) CKEDITOR.tools.setTimeout(function (a, b) {
    ...
    (function () {
                ...
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (h = CKEDITOR.env.opera && !a || (typeof c == "function" ? c(e) !== false : c))
                            if (!p && CKEDITOR.env.ie && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) h = false;
                            else if (!p && CKEDITOR.env.ie && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem)) h = false;
                        else {
                            h = b(e);
        ...
        function u(a) {
            return a.replace(/<\!--(?!{cke_protected})[\s\S]+?--\>/g,
                function (a) {
                    return "<\!--" + D + "{C}" + encodeURIComponent(a)
                        .replace(/--/g, "%2D%2D") + "--\>"
                })
        }
        ...
        function t(a, b) {
            ...
            a = a.replace(e, function (a, b, g) {
                return "<\!--" + D + (b ? "{C}" : "") + encodeURIComponent(c[g])
                    .replace(/--/g, "%2D%2D") +
                    "--\>"
            });
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toDataFormat", function (a) {
                a.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(a.data.dataValue, b.editable()
                    .getName(),
                    c(b.config))
            }, null, null, 5);
            b.on("toDataFormat", function (a) {
    ...
    CKEDITOR.htmlParser.cssStyle = function (a) {
        ...
        ((a instanceof CKEDITOR.htmlParser.element ? a.attributes.style : a) || "")
            .replace(/&quot;/g, '"')
            .replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, f, e) {
    ...
    (function () {
        CKEDITOR.inline = function (a, c) {
            ...
            if (a.getEditor()) throw 'The editor instance "' + a.getEditor()
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
            var f = this.container,
                ...
                r = CKEDITOR.env.webkit && this.document && this.document.getWindow()
                    .$.frameElement,
                e = e ? f.getChild(1) : f;
        ...
        function a(a) {
            ...
            if (c.config.autoParagraph !== false && k != CKEDITOR.ENTER_BR && f.collapsed && g.equals(e) && !d.block) {
                ...
                if (!d.checkForward() || g.checkStartOfBlock() && g.checkEndOfBlock()) {
                    ...
                    if (CKEDITOR.env.ie)(c = c.getFirst(b)) && (c.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(c.getText())
                        .match(/^(?:&nbsp;|\xa0)$/)) && c.remove();
                    f.select();
                    a.cancel()
                }
                ...
                insertElement: function (a) {
                    ...
                    for (var c = this.editor, g = c.config.enterMode,
                        ...
                        if (!m.checkReadOnly()) {
                            ...
                            if (k)
                                for (;
                                    (q = m.getCommonAncestor(0, 1)) && (z = CKEDITOR.dtd[q.getName()]) && (!z || !z[i]);)
                                    if (q.getName() in CKEDITOR.dtd.span) m.splitElement(q);
                    ...
                    if (l) {
                        ...
                        if (k)
                            if ((a = l.getNext(b)) && a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$block)) a.getDtd()["#"] ? m.moveToElementEditStart(a) : m.moveToElementEditEnd(l);
        ...
        var n = function () {
            ...
            function c(b, d) {
                ...
                for (var i = k[i.getName()], j = 0, m = b.getChildren(), n = m.count(), l = -1, u = -1, t = 0, w = g.contains(k.$list); j < n; ++j) {
                    ...
                    if (a(g)) {
                        h = g.getName();
                        if (w && h in CKEDITOR.dtd.$list) o = o.concat(c(g, d));
                        else {
                            f = !! i[h];
            ...
            function f(b, c, d, g) {
                ...
                if ((h = (new CKEDITOR.dom.walker(e))
                        .next()) && a(h) && m[h.getName()] && (k = h.getPrevious()) && a(k) && !k.getParent()
                    .equals(b.startContainer) && d.contains(k) && g.contains(h) && h.isIdentical(k)) {
                    h.moveChildren(k);
                    h.remove();
                    f(b, c, d, g)
                }
            ...
            return function (m, q, t) {
                ...
                if (!A.checkReadOnly()) {
                    ...
                    for (;
                        (C = a(s.startContainer) && s.startContainer.getChild(s.startOffset - 1)) && a(C) && C.isBlockBoundary() && I.contains(C);) s.moveToPosition(C, CKEDITOR.POSITION_BEFORE_END);
                ...
                if (CKEDITOR.env.ie && !p) {
                    ...
                    if (b.$.compatMode != "BackCompat") {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) j.on("mousedown", function (a) {
                            ...
                            a = a.data;
                            if (a.getTarget()
                                .is("html") && a.$.y < j.$.clientHeight && a.$.x < j.$.clientWidth) {
                        ...
                        if (CKEDITOR.env.version > 7) {
                            ...
                            var A = function () {
                                ...
                                var a = CKEDITOR.document.$.selection,
                                    c = a.createRange();
                                a.type != "None" && c.parentElement()
                                    .ownerDocument == b.$ && c.select()
                            }
                        }
                    }
                }
                ...
                var c, f, a = function () {
                        ...
                        if (a)
                            if (a = e(a)) {
                                a.setText(c);
                                if (f) {
                                    b.document.$.defaultView.getSelection()
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        if (n) {
                            ...
                            var b = a[0],
                                a = b.collapsed,
                                k, j, m, l = b.getEnclosedNode();
                            if (l && l.type == CKEDITOR.NODE_ELEMENT && l.getName() in r && (!l.is("a") || !l.getText())) try {
                                m = l.$.createControlRange();
                                m.addElement(l.$);
                                m.select();
                                return
                            } catch (B) {}(b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in
                            ...
                            if (q) {
                                ...
                                k = !(k && k.getText && k.getText()
                                    .match(e)) && (j || !i.hasPrevious() || i.getPrevious()
                                    .is &&
                                    i.getPrevious()
                                    .is("br"));
    ...
    (function () {
                        ...
                        if (!s || i[s] && !t && (!r || h) && (l.getPosition(m) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(l))) {
                            ...
                            if (v && ((v.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(v))) {
                                ...
                                if (q == CKEDITOR.NODE_TEXT || r || q == CKEDITOR.NODE_ELEMENT && !l.getChildCount()) {
                                    for (var q = l, w;
                                        (g = !q.getNext(A)) && (w = q.getParent(), i[w.getName()]) && (w.getPosition(k) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule ||
                                            e.childRule(w));) q = w;
                                    n.setEndAfter(q)
                                }
                            } else g = true
                        ...
                        for (var g = u(this, c), r = g.hasAttributes(), t = n.getCommonAncestor(), q = {}, s = {}, v = {}, D = {}, B, z, F; g && t;) {
                            if (t.getName() == d) {
                                for (B in e.attributes)
                                    if (!D[B] && (F = t.getAttribute(z))) g.getAttribute(B) == F ? s[B] = 1 : D[B] = 1;
                                for (z in e.styles)
                                    if (!v[z] && (F = t.getStyle(z))) g.getStyle(z) == F ? q[z] = 1 : v[z] = 1
                            }
                            t = t.getParent()
                        }
        ...
        function f(a) {
            ...
            (a = (new CKEDITOR.dom.elementPath(b, a.root))
                .contains(this.element, 1)) && !a.isReadOnly() && w(a, this)
        }
        ...
        function e(a) {
            ...
            if (a = (new CKEDITOR.dom.elementPath(b, a.root))
                ...
                var b = this._.definition,
                    c = b.attributes;
                if (c)
                    for (var e in c) a.removeAttribute(e, c[e]);
                if (b.styles)
        ...
        CKEDITOR.style.prototype = {
            ...
            removeFromRange: function (a) {
                return (this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? j : this.type == CKEDITOR.STYLE_OBJECT ? e : null)
                    .call(this, a)
            },
    ...
    CKEDITOR.editor.prototype.getStylesSet = function (a) {
        if (this._.stylesDefinitions) a(this._.stylesDefinitions);
            ...
            if (b === false) a(null);
                ...
                var b = b.split(":"),
                    f = b[0];
                CKEDITOR.stylesSet.addExternal(f, b[1] ? b.slice(1)
    ...
    CKEDITOR.dom.elementPath.prototype = {
        compare: function (a) {
            ...
            for (var b = 0; b < c.length; b++)
                if (!c[b].equals(a[b])) return false;
            return true
        },
    ...
    (function () {
        function a(a, c, e) {
            ...
            if (j.equals(i.getPrevious())) {
                c.startOffset = c.startOffset - j.getLength() - a.getPrevious()
                    .getLength();
                j = a.getNext()
        ...
        CKEDITOR.dialog.prototype = {
            ...
            show: function () {
                var a = this._.element,
                    b = this.definition;
                !a.getParent() || !a.getParent()
                    .equals(CKEDITOR.document.getBody()) ? a.appendTo(CKEDITOR.document.getBody()) :
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, e, d, g, f) {
                    if (!(4 > arguments.length)) {
                        ...
                        this.id = b.id;
                        b.requiredContent && !a.getParentEditor()
                            .filter.check(b.requiredContent) &&
            ...
            return {
                ...
                refresh: function (a, d) {
                    ...
                    c && (b = b ? c.getComputedStyle("direction") :
                        c.getStyle("direction") || c.getAttribute("dir"), a.getCommand("bidirtl")
                        .setState("rtl" == b ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF), a.getCommand("bidiltr")
                        ...
                        for (var h = {}, e = d.createBookmarks(), c = c.createIterator(), g,
                            ...
                            k.evaluator = function (a) {
                                return !!(a.type == CKEDITOR.NODE_ELEMENT && a.getName() in p && !(a.getName() == (b == CKEDITOR.ENTER_P ? "p" : "div") && a.getParent()
                                    ...
                                    .getName()) && a.getPosition(l) & CKEDITOR.POSITION_FOLLOWING && (a.getPosition(m) & CKEDITOR.POSITION_PRECEDING +
                ...
                if (c) {
                    ...
                    if (a == CKEDITOR.TRISTATE_OFF) {
                        ...
                        for (d = {}; 0 < b.length;) f = b.shift(), c = f.getParent(), f.getPrevious() ? f.getNext() ? (f.breakParent(f.getParent()), e.push(f.getNext())) : f.remove()
                            ...
                            .insertBefore(c), c.getCustomData("blockquote_processed") ||
                            ...
                            for (c = !0; a.length;)
                                if (f = a.shift(), "div" == f.getName()) {
                                    ...
                                    c && (f.getPrevious() && !(f.getPrevious()
                                        .type ==
                                        CKEDITOR.NODE_ELEMENT && f.getPrevious()
    ...
    (function () {
        function w(a) {
            ...
            function k(d) {
                ...
                c.on(d, l);
                (7 < CKEDITOR.env.version ? b.$ : b.$.selection.createRange())
                    .execCommand(d);
            ...
            function j(d, b) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    var o = 0,
                        c = c.getWindow();
                    j ? (i.insertAfter(h[0].startNode), i.setStyle("display", "inline")) : (CKEDITOR.env.webkit ? (e.append(i), i.addClass("cke_editable"), o = (e.is("body") ? e : CKEDITOR.dom.element.get(i.$.offsetParent))
                            .getDocumentPosition()
                            .y) : e.getAscendant(CKEDITOR.env.ie || CKEDITOR.env.opera ? "body" : "html", 1)
                        .append(i), i.setStyles({
                            position: "absolute",
                            top: c.getScrollPosition()
                                .y - o + 10 + "px",
                            width: "1px",
                            height: Math.max(1, c.getViewPaneSize()
                                .height - 20) + "px",
                            overflow: "hidden",
                            margin: 0,
                            padding: 0
                    ...
                    (j = i.getParent()
                        .isReadOnly()) ? (i.setOpacity(0), i.setAttribute("contenteditable", !0)) : i.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-1000px");
            ...
            function o() {
                if (CKEDITOR.env.ie) {
                    ...
                    d.lock();
                    if (a.editable()
                        .fire(q) && !k("paste")) return d.unlock(), !1;
                    d.unlock()
                } else try {
                    if (a.editable()
                        .fire(q) && !a.document.$.execCommand("Paste", !1, null)) throw 0;
                } catch (b) {
                    return !1
                }
                return !0
        ...
        function y(a, b) {
            ...
            if (b.match(/^[^<]$/)) return b;
            CKEDITOR.env.webkit && -1 < b.indexOf("<div>") && (b = b.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "<br>")
                .replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "<div></div>"), b.match(/<div>(<br>|)<\/div>/) && (b = "<p>" + b.replace(/(<div>(<br>|)<\/div>)+/g, function (a) {
                    return e(a.split("</div><div>")
                        .length + 1)
                }) + "</p>"), b =
                ...
                if (this.directional) a.on("contentDirChanged", function (b) {
                    var c = CKEDITOR.document.getById(this._.id),
                        d =
                            c.getFirst(),
                        b = b.data;
                    b != a.lang.dir ? c.addClass("cke_" + b) : c.removeClass("cke_ltr")
                        .removeClass("cke_rtl");
                ...
                markItem: function (a) {
                    -1 != a && (a = this.element.getElementsByTag("a")
                        .getItem(this._.focusIndex =
                            a), (CKEDITOR.env.webkit || CKEDITOR.env.opera) && a.getDocument()
                        .getWindow()
            ...
            proto: {
                ...
                focus: function () {
                    if (CKEDITOR.env.webkit) {
                        ...
                        this._.iframe.getFrameDocument()
                        .getWindow())
                        .focus()
                },
                blur: function () {
    ...
    (function () {
                ...
                if (!a.blockless) {
                    ...
                    a.addCommand("creatediv", new CKEDITOR.dialogCommand("creatediv", {
                        ...
                        refresh: function (a, c) {
                            this.setState("div" in (a.config.div_wrapTable ? c.root : c.blockLimit)
        ...
        CKEDITOR.plugins.div = {
            getSurroundDiv: function (a, c) {
                ...
                return a.elementPath(b.blockLimit)
                    .contains("div", 1)
            }
        }
    })();
...
"indent", "blocks", "align"]
    ...
    (function () {
        ...
        p.prototype = {
            ...
            exec: function (d) {
                function i(n) {
                    for (var j = l.startContainer, b = l.endContainer; j && !j.getParent()
                    ...
                    focus: function (a) {
                        ...
                        if (a) {
                            for (var b = this.element.getDocument()
                                .getById(this._.items[a])
                                .getFirst(), a = this.element.getElementsByTag("a"), c, d = -1; c = a.getItem(++d);)
                                if (c.equals(b)) {
                                    this._.focusIndex = d;
                                    break
                                }
    ...
    CKEDITOR.plugins.add("link", {
        ...
        onLoad: function () {
            function b(b) {
                return d.replace(/%1/g, "rtl" == b ? "right" : "left")
    ...
    CKEDITOR.plugins.link = {
        getSelectedLink: function (b) {
            ...
            return d && d.is("a") ? d : (a = a.getRanges(!0)[0]) ? (a.shrink(CKEDITOR.SHRINK_TEXT), b.elementPath(a.getCommonAncestor())
                .contains("a", 1)) : null
        },
...
p(A(O, b), {
        ...
        function W(a) {
            ...
            if (h) {
                ...
                .concat([i ? V : C, F, j, f.equals(a.editable[i ?
                        ...
                        exec: function () {
                            ...
                            "wysiwyg" == a.mode ? j ? (CKEDITOR.env.gecko && q(a), a.getSelection()
                                .selectRanges(j), (i = a.getSelection()
                                    .getStartElement()) && i.scrollIntoView(!0)) :
        ...
        CKEDITOR.plugins.add("showblocks", {
            onLoad: function () {
                ...
                CKEDITOR.addCss(".%2 p,.%2 div,.%2 pre,.%2 address,.%2 blockquote,.%2 h1,.%2 h2,.%2 h3,.%2 h4,.%2 h5,.%2 h6{background-repeat: no-repeat;border: 1px dotted gray;padding-top: 8px;}.%2 p{%1p.png);}.%2 div{%1div.png);}.%2 pre{%1pre.png);}.%2 address{%1address.png);}.%2 blockquote{%1blockquote.png);}.%2 h1{%1h1.png);}.%2 h2{%1h2.png);}.%2 h3{%1h3.png);}.%2 h4{%1h4.png);}.%2 h5{%1h5.png);}.%2 h6{%1h6.png);}".replace(/%1/g,
                        "background-image: url(" + CKEDITOR.getUrl(this.path) + "images/block_")
    ...
    (function () {
            ...
            init: function (a) {
                ...
                a.on("removeFormatCleanup", function (d) {
                    ...
                    a.getCommand("showborders")
                        .state == CKEDITOR.TRISTATE_ON && (d.is("table") && (!d.hasAttribute("border") ||
        ...
        CKEDITOR.on("dialogDefinition", function (a) {
            ...
            if ("table" == b || "tableProperties" == b)
                if (a = a.data.definition, b = a.getContents("info")
    ...
    (function () {
        ...
        function o(e, d) {
            for (var b = p(e), c = b[0], a = c.getAscendant("table"), c = c.getDocument(), f = b[0].getParent(), g = f.$.rowIndex, b = b[b.length - 1], h = b.getParent()
                    .$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(a.$.rows[h]), g = d ? g : h, f = d ? f : b, b = CKEDITOR.tools.buildTableMap(a), a = b[g], g = d ? b[g - 1] : b[g + 1], b = b[0].length,
                    c = c.createElement("tr"), h = 0; a[h] && h < b; h++) {
                var i;
                1 < a[h].rowSpan && g && a[h] == g[h] ? (i = a[h], i.rowSpan += 1) : (i = (new CKEDITOR.dom.element(a[h]))
                    .clone(), i.removeAttribute("rowSpan"), !CKEDITOR.env.ie && i.appendBogus(), c.append(i), i = i.$);
                h += i.colSpan - 1
            }
        ...
        function q(e) {
            if (e instanceof CKEDITOR.dom.selection) {
                for (var d = p(e), b = d[0].getAscendant("table"), c = CKEDITOR.tools.buildTableMap(b), e = d[0].getParent()
                        .$.rowIndex, d = d[d.length - 1], a = d.getParent()
                    ...
                    for (var g = c[f], h = new CKEDITOR.dom.element(b.$.rows[f]), i = 0; i < g.length; i++) {
                        var j = new CKEDITOR.dom.element(g[i]),
                            l = j.getParent()
                                .$.rowIndex;
                        1 == j.$.rowSpan ? j.remove() : (j.$.rowSpan -= 1, l == f && (l = c[f + 1], l[i - 1] ? j.insertAfter(new CKEDITOR.dom.element(l[i - 1])) : (new CKEDITOR.dom.element(b.$.rows[f + 1]))
                            .append(j, 1)));
                        i += j.$.colSpan - 1
                    }
                    d.push(h)
        ...
        function k(e, d) {
            ...
            for (h = 0; h < g; h++) c[h] &&
                (1 < c[h].colSpan && b[h] == c[h] ? (a = c[h], a.colSpan += 1) : (a = (new CKEDITOR.dom.element(c[h]))
                .clone(), a.removeAttribute("colSpan"), !CKEDITOR.env.ie && a.appendBogus(), a[d ? "insertBefore" : "insertAfter"].call(a, new CKEDITOR.dom.element(c[h])), a = a.$), h += a.rowSpan - 1)
        }
    ...
    (function () {
        ...
        i.prototype = {
            ...
            restoreImage: function (a) {
                ...
                a.bookmarks ? d.selectBookmarks(a.bookmarks) : CKEDITOR.env.ie && (c = this.editor.document.getBody()
